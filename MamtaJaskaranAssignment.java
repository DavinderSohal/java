    ...
    public static void main(String[] args)  //Declaration of the main function
    {
        ...
        while(true)  // Implementation of while loop
        {
            ...
            if(choice < 1 || choice > 5)  // Integration of the If- Else Loop
            {
                ...
                continue;
            }else if(choice == 5)   // If user will put the incorrect value, if else loop will run, if user put the
                // right input it will run otherwise it will display message and exit the program
            {
            ...
            System.out.print("Please enter number of rows(between 0 to 10) : ");   //Taking input from the Users for
            // printing the rows
