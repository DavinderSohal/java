...
/* The Output 
Please enter an integer > 0 to display all integers from 1 to that number: 30
...
/* Run Again
Please enter an integer > 0 to display all integers from 1 to that number: -15
...
/* Run Again 
Please enter an integer > 0 to display all integers from 1 to that number: 800
...
/* Run Again - This call will overflow the stack. This is only part of the execution result; the error repeats many more times
Please enter an integer > 0 to display all integers from 1 to that number: 7000
Exception in thread "main" java.lang.StackOverflowError
	at Recursion3.displayNumbers(Recursion3.java:37)
	at Recursion3.displayNumbers(Recursion3.java:37)
	at Recursion3.displayNumbers(Recursion3.java:37)
	at Recursion3.displayNumbers(Recursion3.java:37)
	at Recursion3.displayNumbers(Recursion3.java:37)
